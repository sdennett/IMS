...
$positions = mysql_query("SELECT ID, DATE_FORMAT(InvDate, '%m/%d/%y') as InvDate, DATE_FORMAT(SoldDate, '%m/%d/%y') as SoldDate, Description, Cost,Priced,Sold,Commission,Net,Comments FROM inventory order by Description, InvDate") or die(mysql_error());
